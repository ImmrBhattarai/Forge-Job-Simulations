...
**Objective:** 
Use command line Python to run a program and use its functionality to test whether Sasha meets any of the cloud-native traits, then submit your findings against each of them.

**What I learned in this task:**
- Understood cloud-native traits like 'Redundancy', 'Resiliency' and 'Least-privilege'. Understood the foundation of what makes a good cloud application.
- Learnt basic concepts of how to test a cloud application against each of the cloud-native traits. 
- Installed and utilized Python command line tools on your computer.
- Tested the VPN service against different test cases.


### Task 3: Cloud Based Application Security

**Objective:** 
Follow the steps to explore several websites to conduct your research. Create a PowerPoint presentation using the template that summarizes your research results.

**What I learned in this task:**
- How to effectively conduct research online about securing cloud applications.
- How to demonstrate research results in a clear and effective way.

### Task 4: Recap and Reflection

**Objective:** 
Recap the understanding from the lessons so far and answer quizes related to the work performed.

**What I learned in this task:**
- Went through a revision of the Cloud Application security, Data security, and Network security

## Verizon Communications Inc. Cloud Platform Skills Learned
- Agile Methodology
